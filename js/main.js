...
$(document).ready(function(){
  ...
  $(window).scroll(function() {
    ...
    var countDownDate = new Date("Jun 19, 2019 11:00:00").getTime();
    ...
    var x = setInterval(function() {
        ...
        document.getElementById("timer").innerHTML ="<div class='start-in'>Comienzan en:</div>"+ days + "<span>días  </span>: " + hours + "<span>horas</span>: "
